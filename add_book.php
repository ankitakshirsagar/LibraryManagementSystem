...
<ul>
  ...
  <li ><a href="view1.php">Books </a></li>
 
  <li ><a href="detail.html">Students </a></li>
 <li ><a href="#about">About </a></li>
  <li style="float:right"><a class="active" href="logout.php">Logout</a></li>
</ul>

</div>
  <form action="add_book1.php" method="post">
  <div id="container">
                <form action="gr_no.php" method="post">
                    <label for="book_name" style="color:hsla(0,100%,50%,0.5); font-family:"Helvetica Neue",Helvetica,sans-serif;"><?php  echo @$_GET['msg'];?></label>
                    <label for="book_name">Enter Book Name:</label>
                    <input type="text" id="book_name" name="book_name">
                    
                    
			 <label for="author_name" style="color:hsla(0,100%,50%,0.5); font-family:"Helvetica Neue",Helvetica,sans-serif;"><?php  echo @$_GET['msg'];?></label>
