...
<ul>
 ...
 <li ><a href="#about">About </a></li>
  ...
  <?php
$conn=mysqli_connect("localhost","ankita","orion2001","books") or die("error in connection");

$Book=mysqli_real_escape_string($conn,$_POST['Book']);
$Author=mysqli_real_escape_string($conn,$_POST['Author']);


$sql="insert into details(Book,Author) values ('$book_name','$author_name')";
...
echo "<a href=\"view2.php\">view table</a>";
