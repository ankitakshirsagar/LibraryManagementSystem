...
$bookid1= $rowval['bookid'];

$issuedate1= $rowval['issuedate'];

$returndate1= $rowval['returndate'];
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label for="gr_no">  GR NO :</label> &nbsp;&nbsp;
   <input name="gr_no" type="text" id="textboxid" value="" width="650px" height="40px" value='<?php echo $grno1; ?>'>
  <br><br>
          &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;         <label for="bookid">BOOK ID :</label>&nbsp;&nbsp;&nbsp;
    <input type="text" id="bookid" name="bookid" value='<?php echo $bookid1; ?>' >
                    
                    <br><br>
     &nbsp;&nbsp;&nbsp;&nbsp;              <label for="issuedate">ISSUE DATE :</label>&nbsp;&nbsp;&nbsp;
    <input type="text" id="issuedate" name="issuedate" value='<?php echo $issuedate1; ?>'>
                    
                    <br><br>
                    <label for="returndate">RETURN DATE :</label>&nbsp;&nbsp;&nbsp;
    <input type="text" id="returndate" name="returndate" value='<?php echo $returndate1; ?>'>
                    <br><br>
...
<div class="static1">Issue Book</div>
